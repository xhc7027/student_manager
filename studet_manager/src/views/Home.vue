        ...
        <el-col :span="24" class="header">
            ...
            <el-col :span="4" class="userinfo">
                <el-dropdown trigger="hover">
                    <span class="el-dropdown-link userinfo-inner">{{sysUserName}} <i
                    ...
                    <template v-for="(item,index) in $router.options.routes" v-if="!item.hidden">
                        <template v-if="item.leaf == false">
                            <el-submenu :index="index+''">
                                ...
                                <el-menu-item @click="refresh(child)" v-for="(child,cIndex) in item.children"
                                              v-if="!child.hidden"
                                              :index="child.path">
                                    {{child.name}}
                                </el-menu-item>
...
<script>
    import {getEnv, getMenu} from '../api/api';
